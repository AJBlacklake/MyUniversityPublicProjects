   ...
   public void kaannaVasemmalle() {
    ...
    public void liiku() {
        ...
        if(this.hahmo.getTranslateX() > AsteroidsSovellus.LEVEYS){
            this.hahmo.setTranslateX(0 - this.hahmo.getTranslateX());
        }
        ...
        if(this.hahmo.getTranslateY() > AsteroidsSovellus.KORKEUS){
            this.hahmo.setTranslateY(0 - this.hahmo.getTranslateY() );
        }
        if(this.hahmo.getTranslateY() < 0){
            this.hahmo.setTranslateY( AsteroidsSovellus.KORKEUS + this.hahmo.getTranslateY());
        }
